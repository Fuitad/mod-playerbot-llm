...
if (NOT EXISTS "${PLAYERBOT_LLM_PERSONALITY_HEADER}")
  message(FATAL_ERROR
    "mod-playerbot-llm requires the private mod-playerbots module with the personality "
    "contract (missing ${PLAYERBOT_LLM_PERSONALITY_HEADER}). Install the compatible "
    "mod-playerbots revision recorded in mod-playerbot-llm/PLAYERBOTS_REVISION, or remove "
    "mod-playerbot-llm from the modules directory.")
endif()
