...
// The module is compiled only against personality contract version 2. A newer private
...
static_assert(PLAYERBOT_PERSONALITY_API_VERSION == 2,
              "mod-playerbot-claude requires playerbot personality API version 2");
